let menu = [
  ...
  [
    { item: "Pepperoni Pizza", price: 3.69 },
    { item: "Philly Cheesesteak", price: 3.49 },
    { item: "Cheese Burger", price: 3.29 },
    { item: "Korean Fried Chicken", price: 28.29 },
  ],
  [
    { item: "Orange Chicken", price: 10.69 },
    { item: "Chicken Alfredo", price: 12.49 },
    { item: "Chicken Pot Pie", price: 10.29 },
    { item: "Pasta", price: 11.29 },
    { item: "All you can eat salad bar", price: 12.29 },
  ],
];
